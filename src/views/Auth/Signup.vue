<template>
  <FullScreenLayout>
    <div class="relative flex w-full h-screen overflow-hidden bg-white z-1 dark:bg-gray-900">
      ...
      <div
        class="relative items-center justify-center flex-1 hidden p-8 z-1 bg-brand-950 dark:bg-white/5 lg:flex"
      >
        <CommonGridShape />
