        ...
        <div class="flex flex-col flex-1 w-full lg:w-1/2">
          ...
          <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
            <div>
              ...
              <div
                v-if="errorMessage"
                class="mb-5 p-4 rounded-lg bg-red-50 dark:bg-red-900/10 border border-red-200 dark:border-red-800"
              >
              ...
              <div>
                ...
                <div class="relative py-3 sm:py-5">
                  ...
                  <div class="relative flex justify-center text-sm">
                    <span class="p-2 text-gray-400 bg-white dark:bg-gray-900 sm:px-5 sm:py-2">أو</span>
                  </div>
                </div>
                        ...
                        >
                          ...
                          >
                            <path
                              fill-rule="evenodd"
                              clip-rule="evenodd"
                              d="M9.99972 4.04175C6.48147 4.04175 3.49444 6.30797 2.41505 9.45811C2.36105 9.61568 2.36105 9.78676 2.41505 9.94433C3.49444 13.0945 6.48147 15.3607 9.99972 15.3607C13.518 15.3607 16.505 13.0945 17.5844 9.94433C17.6384 9.78676 17.6384 9.61568 17.5844 9.45811C16.505 6.30797 13.518 4.04175 9.99972 4.04175ZM3.92284 9.70122C4.86759 7.26641 7.23317 5.54175 9.99972 5.54175C12.7663 5.54175 15.1319 7.26641 16.0766 9.70122C15.1319 12.136 12.7663 13.8607 9.99972 13.8607C7.23317 13.8607 4.86759 12.136 3.92284 9.70122Z"
                              fill="#98A2B3"
                            />
                            <path
                              fill-rule="evenodd"
                              clip-rule="evenodd"
                              d="M10.0052 7.38208C8.71895 7.38208 7.67578 8.42525 7.67578 9.71152C7.67578 10.9978 8.71895 12.041 10.0052 12.041C11.2915 12.041 12.3346 10.9978 12.3346 9.71152C12.3346 8.42525 11.2915 7.38208 10.0052 7.38208ZM6.17578 9.71152C6.17578 7.5967 7.89039 5.88208 10.0052 5.88208C12.12 5.88208 13.8346 7.5967 13.8346 9.71152C13.8346 11.8263 12.12 13.541 10.0052 13.541C7.89039 13.541 6.17578 11.8263 6.17578 9.71152Z"
                              fill="#98A2B3"
                            />
                          </svg>
                      ...
                      <div>
                        ...
                        >
                          <div class="relative">
                            ...
                            >
                              <span :class="formData.keepLoggedIn ? '' : 'opacity-0'">
          ...
          <div class="flex items-center justify-center z-1">
            ...
            <div class="flex flex-col items-center max-w-xs">
              ...
              <p class="text-center text-gray-400 dark:text-white/60">
                نظام إدارة متكامل للهوية والصلاحيات
              </p>
            </div>
          </div>
        </div>
...
const handleSubmit = async () => {
  ...
  try {
    ...
    errorMessage.value = err.message || 'فشل تسجيل الدخول. تحقق من البيانات المدخلة.';
  } finally {
